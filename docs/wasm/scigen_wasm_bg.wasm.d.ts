...
export const scigengenerator_load_rules: (a: number, b: number, c: number) => void;
export const scigengenerator_new: (a: bigint) => number;
export const scigengenerator_pretty_print: (a: number, b: number, c: number) => [number, number];
