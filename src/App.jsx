          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 pr-8 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-400"
              />
              {author1 && (
                <button
                  onClick={() => setAuthor1('')}
                  className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 text-lg font-bold"
                  aria-label="Clear first author"
                >
                  ×
                </button>
              )}
            ...
            <div className="relative">
              ...
              {author2 && (
                <button
                  onClick={() => setAuthor2('')}
                  className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 text-lg font-bold"
                  aria-label="Clear second author"
                >
                  ×
                </button>
              )}
